...
def main():
    ...
    p = 0.4
    par = (1, 0.5, p)
    u = RK4(osc_lin, par, np.array([0, 0]), 0, 2000, 0.01)
    poin = poincare(u[0], u[1], 2*np.pi/p, tpoin0)
    ind = 0
    ...
    plt.xlabel(r"$x$")
    plt.ylabel(r"$\dot x$")
    plt.plot(u[1].T[0][ind:], u[1].T[1][ind:])
    plt.plot(poin[1].T[0], poin[1].T[1], "ko")
    plt.show()
    print(clas(poin[1], 1.6))
    ...
    plt.plot(poin[1].T[0], poin[1].T[1], "ko")
    plt.show()
    print(clas(poin[1], 0.2))

    #Duffing
    tpoin0 = 500
    p = 0.3
    par = (0.1, 1, 3, 1, p)
    u = RK4(duffing, par, np.array([0, 0]), 0, 2000, 0.01)
    poin = poincare(u[0], u[1], 2*np.pi/p, tpoin0)
    ind = 0
    for i in range(u[0].size):
        if u[0][i] > tpoin0: ind = i; break
    ...
    p = 0.1
    par = (0.2, 1, 1, p)
    u = RK4(pend, par, np.array([0, 0]), 0, 2000, 0.01)
    poin = poincare(u[0], u[1], 2*np.pi/p, tpoin0)
    ind = 0
    for i in range(u[0].size):
        if u[0][i] > tpoin0: ind = i; break
    ...
    p = 0.4
    par = (1, 0.5, p)
    u = DOPRI45(osc_lin, par, np.array([0, 0]), 0, 2000, 0.01)
    poin = poincare(u[0], u[1], 2*np.pi/p, tpoin0)
    ind = 0
    for i in range(u[0].size):
        if u[0][i] > tpoin0: ind = i; break
    ...
    p = 0.1
    par = (0.2, 1, 1, p)
    u = DOPRI45(pend, par, np.array([0, 0]), 0, 2000, 0.01)
    poin = poincare(u[0], u[1], 2*np.pi/p, tpoin0)
    ind = 0
    for i in range(u[0].size):
        if u[0][i] > tpoin0: ind = i; break
